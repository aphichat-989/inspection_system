...
class InspectionRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ("sd_code", "part_name", "line__name", "product_model__name", "test_condition__name", "notes")
...
class InspectionDefectAdmin(admin.ModelAdmin):
    ...
    search_fields = ("inspection__sd_code", "inspection__part_name", "inspection__line__name", "inspection__product_model__name", "defect_type__name")
